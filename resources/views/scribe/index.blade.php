...
<head>
    ...
    <title>Leads API API Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-auth-register">Registreer een nieuwe gebruiker</a>
                            </li>
...
<p>Login via <code>POST /api/auth/login</code> to get your access token.</p>

        <h1 id="auth">Auth</h1>

    <p>APIs voor authenticatie</p>

                                <h2 id="auth-POSTapi-auth-register">Registreer een nieuwe gebruiker</h2>

<p>
</p>

<p>Maakt een nieuw account aan en retourneert een API-token.</p>
...
<span id="example-responses-POSTapi-auth-register">
            <blockquote>
            <p>Example response (201, Gebruiker succesvol geregistreerd):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;token_type&quot;: &quot;bearer&quot;
            ...
            <blockquote>
            <p>Example response (422, Validatiefout):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>De naam van de gebruiker. Minimaal 2 karakters. Example: <code>Jan de Vries</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Het e-mailadres. Example: <code>jan@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Het wachtwoord. Minimaal 8 karakters. Example: <code>wachtwoord123</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Bevestiging van het wachtwoord. Example: <code>wachtwoord123</code></p>
        </div>
        </form>

                    <h2 id="auth-POSTapi-auth-login">Inloggen</h2>

<p>
</p>

<p>Authenticeer met e-mail en wachtwoord, retourneert een API-token.</p>
...
<span id="example-responses-POSTapi-auth-login">
            <blockquote>
            <p>Example response (200, Succesvol ingelogd):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;token_type&quot;: &quot;bearer&quot;
            ...
            <blockquote>
            <p>Example response (401, Ongeldige inloggegevens):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Het wachtwoord. Example: <code>wachtwoord123</code></p>
        </div>
        </form>
...
<p>Invalideer het huidige API-token.</p>
...
<span id="example-responses-POSTapi-auth-logout">
            <blockquote>
            <p>Example response (200, Succesvol uitgelogd):</p>
        </blockquote>
                <pre>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="auth-GETapi-auth-me">Huidige gebruiker ophalen</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retourneert de gegevens van de ingelogde gebruiker.</p>
...
<span id="example-responses-GETapi-auth-me">
            <blockquote>
            <p>Example response (200, Succesvolle operatie):</p>
        </blockquote>
                <pre>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs voor het beheren van leads</p>
                                ...
                                <h2 id="leads-GETapi-leads">Alle leads ophalen</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retourneert een gepagineerde lijst van leads. Ondersteunt zoeken, filteren op status en sorteren.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/leads?search=jan&amp;status=nieuw&amp;sort=desc&amp;per_page=15" \
    --header "Authorization: Bearer {YOUR_ACCESS_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;links&quot;: {
        &quot;first&quot;: &quot;http://localhost/api/leads?page=1&quot;,
        &quot;last&quot;: &quot;http://localhost/api/leads?page=5&quot;,
        &quot;prev&quot;: null,
        &quot;next&quot;: &quot;http://localhost/api/leads?page=2&quot;
    },
    &quot;meta&quot;: {
        &quot;current_page&quot;: 1,
        &quot;last_page&quot;: 5,
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="search"                data-endpoint="GETapi-leads"
               value="jan"
               data-component="query">
    <br>
<p>Zoek op naam of e-mail. Example: <code>jan</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter op status. Example: <code>nieuw</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Sorteerrichting (asc of desc). Example: <code>desc</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Aantal resultaten per pagina (1-100). Example: <code>15</code></p>
            </div>
                        <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>search</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>verkocht</code></p>
Must be one of:
...
<p>Must be at least 1. Must not be greater than 100. Example: <code>22</code></p>
                    ...
                    <h2 id="leads-POSTapi-leads">Nieuwe lead aanmaken</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Maak een nieuwe lead aan met de opgegeven gegevens.</p>
...
<span id="example-responses-POSTapi-leads">
            <blockquote>
            <p>Example response (201, Lead succesvol aangemaakt):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>De naam van de lead. Minimaal 2 karakters. Example: <code>Jan de Vries</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Het e-mailadres van de lead. Example: <code>jan@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>De bron van de lead. Mogelijke waarden: website, email, telefoon, whatsapp, showroom, overig. Example: <code>website</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>De status van de lead. Mogelijke waarden: nieuw, opgepakt, proefrit, offerte, verkocht, afgevallen. Example: <code>nieuw</code></p>
        </div>
        </form>

                    <h2 id="leads-GETapi-leads--id-">Lead ophalen op ID</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retourneert de gegevens van een specifieke lead.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <blockquote>
            <p>Example response (404, Lead niet gevonden):</p>
        </blockquote>
                <pre>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-leads--id-"
               value="1"
               data-component="url">
    <br>
<p>Het ID van de lead. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="leads-PUTapi-leads--id-">Lead bijwerken</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Werk een bestaande lead bij. Alle velden zijn optioneel (partial update).</p>
...
<span id="example-responses-PUTapi-leads--id-">
            <blockquote>
            <p>Example response (200, Lead succesvol bijgewerkt):</p>
        </blockquote>
                <pre>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-leads--id-"
               value="1"
               data-component="url">
    <br>
<p>Het ID van de lead. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>De naam van de lead. Minimaal 2 karakters. Example: <code>Piet Jansen</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="piet@example.com"
               data-component="body">
    <br>
<p>Het e-mailadres van de lead. Example: <code>piet@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>source</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>De bron van de lead. Mogelijke waarden: website, email, telefoon, whatsapp, showroom, overig. Example: <code>email</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>De status van de lead. Mogelijke waarden: nieuw, opgepakt, proefrit, offerte, verkocht, afgevallen. Example: <code>opgepakt</code></p>
        </div>
        </form>

                    <h2 id="leads-DELETEapi-leads--id-">Lead verwijderen</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Verwijder een lead op basis van ID.</p>
...
<span id="example-responses-DELETEapi-leads--id-">
            <blockquote>
            <p>Example response (204, Lead succesvol verwijderd):</p>
        </blockquote>
                <pre>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-leads--id-"
               value="1"
               data-component="url">
    <br>
<p>Het ID van de lead. Example: <code>1</code></p>
